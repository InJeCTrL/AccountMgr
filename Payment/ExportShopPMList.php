<?php
	...
	if (isset($_SESSION['Online']) && $_SESSION['Online'] == 1)
	{
		...
		// 获取商铺缴费月份列表
		$Res = GetShopListByPaymentMonth($conn, 0, 0, $_SESSION['UserID'], $AID, $ShopName, $Name, $TEL, $Year, $Month, $ShowPaid);
		ob_clean();
		header("Content-Type: application/force-download");
		header("Content-type:text/csv;charset=gb2312");
		header("Content-Disposition:filename=商铺缴费月份.csv");
		echo iconv("utf-8", "gb2312", "\"时间\",\"楼盘名称\",\"商铺名称\",\"店主姓名\",\"电话号码\"\r");
		ob_end_flush();
